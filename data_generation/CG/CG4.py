    ...
    for atom in mol.GetAtoms():
        if atom.GetAtomicNum() == 16:  # Check if the atom is sulfur (S)
            ...
            for neighbor in neighbors:
                ...
                idx_groups.append([atom.GetIdx(),neighbor.GetIdx()])
                type_groups.append(int(16/2+6))
        ...
        if atom.IsInRing():
            ...
            if nb_no_ring == 0: # -H
                ...
                if neighbor_tmp.GetAtomicNum() != 6:
                    ...
                    bead_type+= neighbor_tmp.GetAtomicNum()
                    type_groups.append(bead_type) # 6+9

                # if neighbor_tmp.GetAtomicNum() == 8:
                #     idx_groups.append(idx_tmp) # O
                #     type_groups.append(20) # 6+8+6
...
torch.save(cg_data_all, './data_CG4.pt')
